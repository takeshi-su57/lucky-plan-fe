...
import { FastTotalDevV6Panel } from "./FastTotalDevV6Panel";
import { TestParamsV6View } from "./TestParamsV6";

import { TestingReportV6Panel } from "./TestingReportV6Panel";
...
export function DevPanelV6() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {selected === "reports" && <TestingReportV6Panel />}
    </div>
  );
}
