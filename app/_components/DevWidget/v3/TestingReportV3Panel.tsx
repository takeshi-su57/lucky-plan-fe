...
import { useGetTestingReportV3 } from "@/app/_hooks/useHistory";

import { Virtuoso } from "react-virtuoso";
import { getPriceStr } from "@/utils/price";
import LineChart from "@/components/charts/LineChart";

export function TestingReportV3Panel() {
  const { reports, loading, fetchMore, hasMore } = useGetTestingReportV3();
