...
export type SimulationResearchDetailsInfoFragment = { __typename?: 'SimulationResearchDetails', completedSimulations: number, createdAt: any, days: number, description: string, direction: BotMode, endAt: any, gapDays: number, id: number, scoreFormular: SimulationScoreFormular, sizingFormular: SimulationSizingFormular, status: SimulationStatus, cursor?: any | null, progressPhase?: string | null, progressMessage?: string | null, progressPercent: number, totalRanges: number, completedRanges: number, startedAt?: any | null, finishedAt?: any | null, lastError?: string | null, platform: Platform, startAt: any, title: string, totalSimulations: number, updatedAt: any, collateral: Array<{ __typename?: 'SimulationValueRangeGroup', ranges: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }> }>, leverage: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, score: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, r2: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, slope: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, trade: Array<{ __typename?: 'SimulationTradeRange', max: number, min: number }>, simulations: Array<(
    { __typename?: 'Simulation' }
