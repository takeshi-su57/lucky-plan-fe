...
export type Query = {
  ...
  getAllLeaders: Array<UserHistory>;
...
export type QueryGetAllLeadersArgs = {
  contractId: Scalars['Int']['input'];
};
...
export type GetAllLeadersQueryVariables = Exact<{
  contractId: Scalars['Int']['input'];
}>;
