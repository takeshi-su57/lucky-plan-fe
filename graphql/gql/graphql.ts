...
export type FollowerTrade = {
  ...
  address: Scalars['String']['output'];
  index: Scalars['Int']['output'];
  mission?: Maybe<MissionExtForwardDetails>;
  params: Scalars['String']['output'];
};
...
export type MissionExtForwardDetails = {
...
export type FollowerTradeInfoFragment = { __typename?: 'FollowerTrade', address: string, index: number, params: string, mission?: (
    { __typename?: 'MissionExtForwardDetails' }
    & { ' $fragmentRefs'?: { 'MissionExtForwardDetailsInfoFragment': MissionExtForwardDetailsInfoFragment } }
...
export type MissionExtForwardDetailsInfoFragment = { __typename?: 'MissionExtForwardDetails', id: number, botId: number, targetPositionId: number, achievePositionId?: number | null, createdAt: any, updatedAt: any, status: MissionStatus, achievePosition?: (
    { __typename?: 'Position' }
    & { ' $fragmentRefs'?: { 'PositionInfoFragment': PositionInfoFragment } }
  ) | null, targetPosition: (
    { __typename?: 'Position' }
    ...
    { __typename?: 'TaskForwardDetails' }
    & { ' $fragmentRefs'?: { 'TaskForwardDetailsInfoFragment': TaskForwardDetailsInfoFragment } }
  )>, bot: { __typename?: 'Bot', endedAt?: any | null, followerAddress: string, followerContractId: number, followerEndedBlock?: number | null, followerStartedBlock?: number | null, id: number, leaderAddress: string, leaderCollateralBaseline: number, leaderContractId: number, leaderEndedBlock?: number | null, leaderStartedBlock?: number | null, planId: number, startedAt?: any | null, status: BotStatus, strategyId: number } } & { ' $fragmentName'?: 'MissionExtForwardDetailsInfoFragment' };
