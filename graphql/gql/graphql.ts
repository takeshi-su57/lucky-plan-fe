...
export type Query = {
  ...
  isBotHookRunning: Scalars['Boolean']['output'];
...
export type GetIsBotHookRunningQueryVariables = Exact<{ [key: string]: never; }>;


export type GetIsBotHookRunningQuery = { __typename?: 'Query', isBotHookRunning: boolean };
...
export const GetIsBotHookRunningDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getIsBotHookRunning"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isBotHookRunning"}}]}}]} as unknown as DocumentNode<GetIsBotHookRunningQuery, GetIsBotHookRunningQueryVariables>;
