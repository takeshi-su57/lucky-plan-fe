...
export type SimulationInfoFragment = { __typename?: 'Simulation', closeFeeRate: number, completedPlans: number, createdAt: any, cursor?: any | null, description: string, endAt: any, error?: string | null, id: number, maxCollateralUsd: number, maxDrawdownUsd: number, maxLeverage: number, maxRatio: number, minCollateralUsd: number, minNegativeR2: number, minRatio: number, minTrades: number, openFeeRate: number, platform: Platform, profitFactor: number, progressMessage?: string | null, progressPercent: number, progressPhase?: string | null, selectedLeaderCount: number, slippageRate: number, standardCollateralUsd: number, startAt: any, status: SimulationStatus, title: string, totalCostUsd: number, totalFollowerPnl: number, totalLeaderPnl: number, totalNetPnlUsd: number, totalSimulationPlans: number, tradeCount: number, updatedAt: any, winRate: number } & { ' $fragmentName'?: 'SimulationInfoFragment' };
...
export type SimulationPlanDetailsInfoFragment = { __typename?: 'SimulationPlanDetails', cursor: any, description: string, endAt: any, id: number, openedPositions: number, startAt: any, title: string, totalFollowerPnl: number, totalLeaderPnl: number, totalPositions: number, simulationBots: Array<(
    { __typename?: 'SimulationBotDetails' }
