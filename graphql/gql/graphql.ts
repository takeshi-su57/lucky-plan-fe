...
export type BacktestTask = {
  ...
  optunaStudyPath?: Maybe<Scalars['String']['output']>;
...
export type Query = {
  ...
  optunaStudyDates: Array<Scalars['String']['output']>;
...
export type QueryOptunaStudyDatesArgs = {
  taskId: Scalars['ID']['input'];
};
...
export type BacktestTaskInfoFragment = { __typename?: 'BacktestTask', id: string, name: string, symbol: string, status: BacktestTaskStatus, totalConfigs: number, processedConfigs: number, currentConfig?: string | null, startDate: any, endDate: any, interval: string, optimizationParams: any, searchStrategy: string, optimizationMetrics: Array<string>, trials?: number | null, bestConfigIds: Array<string>, optunaStudyPath?: string | null, optimizerPid?: number | null, createdAt: any, startedAt?: any | null, completedAt?: any | null, errorMessage?: string | null } & { ' $fragmentName'?: 'BacktestTaskInfoFragment' };
...
export type BacktestComponentsQuery = { __typename?: 'Query', backtestComponents: { __typename?: 'BacktestComponents', signals: Array<{ __typename?: 'ComponentInfo', name: string, description?: string | null, params: Array<{ __typename?: 'ParamInfo', name: string, type: string, required: boolean, default?: string | null, description?: string | null, min?: number | null, max?: number | null }> }>, filters: Array<{ __typename?: 'ComponentInfo', name: string, description?: string | null, params: Array<{ __typename?: 'ParamInfo', name: string, type: string, required: boolean, default?: string | null, description?: string | null, min?: number | null, max?: number | null }> }>, risk: Array<{ __typename?: 'ComponentInfo', name: string, description?: string | null, params: Array<{ __typename?: 'ParamInfo', name: string, type: string, required: boolean, default?: string | null, description?: string | null, min?: number | null, max?: number | null }> }>, exits: Array<{ __typename?: 'ComponentInfo', name: string, description?: string | null, params: Array<{ __typename?: 'ParamInfo', name: string, type: string, required: boolean, default?: string | null, description?: string | null, min?: number | null, max?: number | null }> }>, platforms: Array<{ __typename?: 'ComponentInfo', name: string, description?: string | null, params: Array<{ __typename?: 'ParamInfo', name: string, type: string, required: boolean, default?: string | null, description?: string | null, min?: number | null, max?: number | null }> }> } };
...
export type OptunaDashboardStatusQuery = { __typename?: 'Query', optunaDashboardStatus: { __typename?: 'OptunaDashboardStatus', running: boolean, taskId?: string | null, url?: string | null } };

export type OptunaStudyDatesQueryVariables = Exact<{
  taskId: Scalars['ID']['input'];
}>;


export type OptunaStudyDatesQuery = { __typename?: 'Query', optunaStudyDates: Array<string> };
...
export type StartOptunaDashboardMutation = { __typename?: 'Mutation', startOptunaDashboard: { __typename?: 'OptunaDashboardStatus', running: boolean, taskId?: string | null, url?: string | null } };
...
export const OptunaStudyDatesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OptunaStudyDates"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"taskId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"optunaStudyDates"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"taskId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"taskId"}}}]}]}}]} as unknown as DocumentNode<OptunaStudyDatesQuery, OptunaStudyDatesQueryVariables>;
...
export const StartOptunaDashboardDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"StartOptunaDashboard"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"taskId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"date"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"port"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"startOptunaDashboard"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"taskId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"taskId"}}},{"kind":"Argument","name":{"kind":"Name","value":"date"},"value":{"kind":"Variable","name":{"kind":"Name","value":"date"}}},{"kind":"Argument","name":{"kind":"Name","value":"port"},"value":{"kind":"Variable","name":{"kind":"Name","value":"port"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"running"}},{"kind":"Field","name":{"kind":"Name","value":"taskId"}},{"kind":"Field","name":{"kind":"Name","value":"url"}}]}}]}}]} as unknown as DocumentNode<StartOptunaDashboardMutation, StartOptunaDashboardMutationVariables>;
