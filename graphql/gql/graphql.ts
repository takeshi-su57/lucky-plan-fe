...
export type SimulationInfoFragment = { __typename?: 'Simulation', completedPlans: number, createdAt: any, cursor?: any | null, days: number, description: string, direction: BotMode, endAt: any, error?: string | null, gapDays: number, id: number, maxDrawdownUsd: number, platform: Platform, profitFactor: number, progressMessage?: string | null, progressPercent: number, progressPhase?: string | null, researchId?: number | null, selectedLeaderCount: number, standardCollateralUsd: number, startAt: any, status: SimulationStatus, title: string, totalCostUsd: number, totalFollowerPnl: number, totalLeaderPnl: number, totalNetPnlUsd: number, totalSimulationPlans: number, tradeCount: number, updatedAt: any, winRate: number, leverage: { __typename?: 'SimulationValueRange', max: number, min: number }, r2: { __typename?: 'SimulationValueRange', max: number, min: number }, score: { __typename?: 'SimulationValueRange', max: number, min: number }, slope: { __typename?: 'SimulationValueRange', max: number, min: number }, trade: { __typename?: 'SimulationTradeRange', max: number, min: number } } & { ' $fragmentName'?: 'SimulationInfoFragment' };

export type SimulationResearchInfoFragment = { __typename?: 'SimulationResearch', completedSimulations: number, createdAt: any, days: number, description: string, direction: BotMode, endAt: any, gapDays: number, id: number, platform: Platform, startAt: any, title: string, totalSimulations: number, updatedAt: any, leverage: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, score: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, r2: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, slope: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, trade: Array<{ __typename?: 'SimulationTradeRange', max: number, min: number }> } & { ' $fragmentName'?: 'SimulationResearchInfoFragment' };

export type SimulationResearchDetailsInfoFragment = { __typename?: 'SimulationResearchDetails', completedSimulations: number, createdAt: any, days: number, description: string, direction: BotMode, endAt: any, gapDays: number, id: number, platform: Platform, startAt: any, title: string, totalSimulations: number, updatedAt: any, leverage: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, score: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, r2: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, slope: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, trade: Array<{ __typename?: 'SimulationTradeRange', max: number, min: number }>, simulations: Array<(
    { __typename?: 'Simulation' }
