...
export type GetSimulationEvaluatorWorkersQuery = { __typename?: 'Query', simulationEvaluatorWorkers: Array<{ __typename?: 'SimulationEvaluatorWorkerView', id: string, displayName: string, authorizationStatus: string, runtimeStatus: string, desiredState: string, desiredCapacity: number, activeCapacity: number, claimedEvaluationTasks: number, evaluationClaimLimit: number, lastHeartbeatAt?: any | null, lastTaskAt?: any | null, lastError?: string | null, lastDiagnosticAt?: any | null, lastDiagnostic?: { __typename?: 'SimulationEvaluatorWorkerDiagnosticView', pid: number, uptimeSeconds: number, childCapacity: number, childCount: number, idleChildCount: number, runningTaskCount: number, lastPollAt?: any | null, lastPollError?: string | null, recentLogs: Array<{ __typename?: 'SimulationEvaluatorWorkerDiagnosticLogView', at: any, level: string, message: string }> } | null, platformCaches: Array<{ __typename?: 'SimulationEvaluatorWorkerCacheView', id: number, platform: string, status: string, coveredStartAt?: any | null, coveredEndAt?: any | null, lastError?: string | null }>, prebuildProgress?: { __typename?: 'SimulationEvaluatorWorkerPrebuildProgressView', taskId: string, message: string, percent: number, records: string, totalRecords: string, bytes: string } | null }> };
