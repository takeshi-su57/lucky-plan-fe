...
export type GetSimulationEvaluatorWorkerTasksQuery = { __typename?: 'Query', simulationEvaluatorWorkerTasks: Array<{ __typename?: 'SimulationEvaluatorWorkerTaskView', id: string, kind: string, status: string, syncStatus: string, platform?: string | null, targetWorkerId?: string | null, workerId?: string | null, rangeStartedAt: any, rangeEndedAt: any, claimedAt?: any | null, leaseExpiresAt?: any | null, completedAt?: any | null, progressPercent: number, progressMessage: string, progressRecords: string, progressTotalRecords: string, progressBytes: string, lastError?: string | null, canCancel: boolean, createdAt: any }> };
