...
export type SimulationInfoFragment = { __typename?: 'Simulation', completedPlans: number, createdAt: any, cursor?: any | null, description: string, endAt: any, error?: string | null, id: number, maxDrawdownUsd: number, maxLeverage: number, minNegativeR2: number, minTrades: number, platform: Platform, profitFactor: number, progressMessage?: string | null, progressPercent: number, progressPhase?: string | null, selectedLeaderCount: number, standardCollateralUsd: number, startAt: any, status: SimulationStatus, title: string, totalCostUsd: number, totalFollowerPnl: number, totalLeaderPnl: number, totalNetPnlUsd: number, totalSimulationPlans: number, tradeCount: number, updatedAt: any, winRate: number } & { ' $fragmentName'?: 'SimulationInfoFragment' };
