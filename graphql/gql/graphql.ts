...
export type SimulationResearchInfoFragment = { __typename?: 'SimulationResearch', completedSimulations: number, createdAt: any, days: number, description: string, direction: BotMode, endAt: any, gapDays: number, id: number, scoreFormular: SimulationScoreFormular, sizingFormular: SimulationSizingFormular, platform: Platform, startAt: any, title: string, totalSimulations: number, updatedAt: any, leverage: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, score: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, r2: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, slope: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, trade: Array<{ __typename?: 'SimulationTradeRange', max: number, min: number }> } & { ' $fragmentName'?: 'SimulationResearchInfoFragment' };

export type SimulationResearchDetailsInfoFragment = { __typename?: 'SimulationResearchDetails', completedSimulations: number, createdAt: any, days: number, description: string, direction: BotMode, endAt: any, gapDays: number, id: number, scoreFormular: SimulationScoreFormular, sizingFormular: SimulationSizingFormular, platform: Platform, startAt: any, title: string, totalSimulations: number, updatedAt: any, leverage: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, score: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, r2: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, slope: Array<{ __typename?: 'SimulationValueRange', max: number, min: number }>, trade: Array<{ __typename?: 'SimulationTradeRange', max: number, min: number }>, simulations: Array<(
    { __typename?: 'Simulation' }
