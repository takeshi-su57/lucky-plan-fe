...
export type BehavioralFiltersInput = {
  directionalLossPurity?: InputMaybe<Array<BehavioralFloatRangeInput>>;
  medianPostLossLeverageRatio?: InputMaybe<Array<BehavioralFloatRangeInput>>;
  negativeActiveDayRate?: InputMaybe<Array<BehavioralFloatRangeInput>>;
};

export type BehavioralFloatRangeInput = {
...
export type CreateSimulationResearchInput = {
  behavioralFilters?: InputMaybe<BehavioralFiltersInput>;
...
export type LogReviewWeek = {
  __typename?: 'LogReviewWeek';
...
export type MutationPrebuildSimulationEvaluatorWorkerArgs = {
  ...
  refreshExisting?: InputMaybe<Scalars['Boolean']['input']>;
...
export type MutationReviewLogWeekArgs = {
...
export type Query = {
  ...
  logReviewWeeks: Array<LogReviewWeek>;
...
export type Simulation = {
  ...
  behavioralFiltersJson: Scalars['String']['output'];
...
export type SimulationBot = {
  ...
  behavioralFeaturesJson?: Maybe<Scalars['String']['output']>;
...
export type SimulationEvaluatorPipelineView = {
  ...
  sourceDerivedFailed: Scalars['Int']['output'];
  sourceDerivedReadyToRecalculate: Scalars['Int']['output'];
  sourceDerivedRecalculating: Scalars['Int']['output'];
  sourceDerivedWaitingToMaterialize: Scalars['Int']['output'];
...
export type SimulationResearch = {
  ...
  awaitingEventPlans: Scalars['Int']['output'];
  behavioralFiltersJson: Scalars['String']['output'];
...
export type SimulationWorkflowConfigView = {
  ...
  sourceDerivedRecalculationConcurrency: Scalars['Int']['output'];
};
...
export type UpdateSimulationWorkflowConfigInput = {
  ...
  sourceDerivedRecalculationConcurrency?: InputMaybe<Scalars['Int']['input']>;
};
...
export type LogInfoFragment = { __typename?: 'Log', id: string, severity: LogSeverity, summary: string, details?: string | null, service: string, timestamp: any, checked: boolean } & { ' $fragmentName'?: 'LogInfoFragment' };
...
export type AllLogsQuery = { __typename?: 'Query', allLogs: { __typename?: 'LogsConnection', edges: Array<{ __typename?: 'LogsEdge', cursor: string, node: (
        { __typename?: 'Log' }
        & { ' $fragmentRefs'?: { 'LogInfoFragment': LogInfoFragment } }
      ) }>, pageInfo: { __typename?: 'LogsPageInfo', endCursor?: string | null, hasNextPage: boolean } } };
...
export type LogReviewWeeksQueryVariables = Exact<{ [key: string]: never; }>;


export type LogReviewWeeksQuery = { __typename?: 'Query', logReviewWeeks: Array<{ __typename?: 'LogReviewWeek', weekStart: any, reviewedAt?: any | null, reviewedBy?: string | null }> };

export type ReviewLogWeekMutationVariables = Exact<{
  weekStart: Scalars['Date']['input'];
}>;


export type ReviewLogWeekMutation = { __typename?: 'Mutation', reviewLogWeek: { __typename?: 'LogReviewWeek', weekStart: any, reviewedAt?: any | null, reviewedBy?: string | null } };
...
export type GetSimulationEvaluatorPipelineQuery = { __typename?: 'Query', simulationEvaluatorPipeline: { __typename?: 'SimulationEvaluatorPipelineView', fleetCapacity: number, queueLowWatermark: number, queueHighWatermark: number, workerClaimLimit: number, queuedEvaluationTasks: number, readyEvaluationTasks: number, claimedEvaluationTasks: number, awaitingFinalizationPlans: number, finalizingPlans: number, awaitingEventLogPlans: number, readyToFinalizeSimulations: number, finalizingSimulations: number, failedExecutionPlans: number, outstandingExecutionPlans: number, finalizerConcurrency: number, maxAwaitingFinalizationPlans: number, maxOutstandingDynamicPlans: number, backpressureActive: boolean, sourceDerivedWaitingToMaterialize: number, sourceDerivedReadyToRecalculate: number, sourceDerivedRecalculating: number, sourceDerivedFailed: number } };
...
export type PrebuildSimulationEvaluatorWorkerWithCacheRefreshMutationVariables = Exact<{
  workerId: Scalars['String']['input'];
  platform: Scalars['String']['input'];
  startedAt: Scalars['String']['input'];
  endedAt: Scalars['String']['input'];
...
export type PrebuildSimulationEvaluatorWorkerWithCacheRefreshMutation = { __typename?: 'Mutation', prebuildSimulationEvaluatorWorker: string };
...
export type SimulationBotDetailsInfoFragment = { __typename?: 'SimulationBotDetails', avgCollateral: number, avgDuration: number, avgLeverage: number, avgNegativePnl: number, avgPnl: number, avgPnlPercentageByCollateral: number, avgPnlPercentageBySize: number, avgPositivePnl: number, avgSize: number, baseRatio: number, id: number, leaderAddress: string, leaderPlatform: Platform, minCollateral: number, maxCollateral: number, minSize: number, maxSize: number, maxDuration: number, mode: BotMode, openedPositions: number, ratio: number, score: number, simulationPlanId: number, startedAt: any, stoppedAt?: any | null, totalPnl: number, totalPositions: number, minLeverage: number, maxLeverage: number, behavioralFeaturesJson?: string | null, leaderExecutionCollateral: Array<{ __typename?: 'SimulationValueRange', min: number, max: number }>, leaderExecutionSize: Array<{ __typename?: 'SimulationValueRange', min: number, max: number }>, leaderExecutionLeverage: Array<{ __typename?: 'SimulationValueRange', min: number, max: number }>, evaluationMetrics: { __typename?: 'LeaderEvaluationMetrics', tradeCount: number, slope: number, r2: number, copiedPnlUsd: number, copiedProfitFactor: number, copiedMaxDrawdownUsd: number }, followerRiskSize: Array<{ __typename?: 'SimulationValueRange', min: number, max: number }>, followerRiskCollateral: Array<{ __typename?: 'SimulationValueRange', min: number, max: number }>, cacheState?: { __typename?: 'SimulationBotCacheState', completed: boolean, lastError?: string | null, lastFetchedAt?: any | null, rebuildRequested: boolean, rebuilding: boolean } | null, positions: Array<(
    { __typename?: 'SimulationTradePosition' }
...
export const CheckLogDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"checkLog"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"checkLog"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"LogInfo"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"LogInfo"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Log"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"severity"}},{"kind":"Field","name":{"kind":"Name","value":"summary"}},{"kind":"Field","name":{"kind":"Name","value":"details"}},{"kind":"Field","name":{"kind":"Name","value":"service"}},{"kind":"Field","name":{"kind":"Name","value":"timestamp"}},{"kind":"Field","name":{"kind":"Name","value":"checked"}}]}}]} as unknown as DocumentNode<CheckLogMutation, CheckLogMutationVariables>;
export const LogReviewWeeksDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"logReviewWeeks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"logReviewWeeks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"weekStart"}},{"kind":"Field","name":{"kind":"Name","value":"reviewedAt"}},{"kind":"Field","name":{"kind":"Name","value":"reviewedBy"}}]}}]}}]} as unknown as DocumentNode<LogReviewWeeksQuery, LogReviewWeeksQueryVariables>;
export const ReviewLogWeekDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"reviewLogWeek"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"weekStart"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Date"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"reviewLogWeek"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"weekStart"},"value":{"kind":"Variable","name":{"kind":"Name","value":"weekStart"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"weekStart"}},{"kind":"Field","name":{"kind":"Name","value":"reviewedAt"}},{"kind":"Field","name":{"kind":"Name","value":"reviewedBy"}}]}}]}}]} as unknown as DocumentNode<ReviewLogWeekMutation, ReviewLogWeekMutationVariables>;
...
export const PrebuildSimulationEvaluatorWorkerWithCacheRefreshDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"prebuildSimulationEvaluatorWorkerWithCacheRefresh"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"workerId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"platform"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"startedAt"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"endedAt"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"refreshExisting"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"prebuildSimulationEvaluatorWorker"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"workerId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"workerId"}}},{"kind":"Argument","name":{"kind":"Name","value":"platform"},"value":{"kind":"Variable","name":{"kind":"Name","value":"platform"}}},{"kind":"Argument","name":{"kind":"Name","value":"startedAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"startedAt"}}},{"kind":"Argument","name":{"kind":"Name","value":"endedAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"endedAt"}}},{"kind":"Argument","name":{"kind":"Name","value":"refreshExisting"},"value":{"kind":"Variable","name":{"kind":"Name","value":"refreshExisting"}}}]}]}}]} as unknown as DocumentNode<PrebuildSimulationEvaluatorWorkerWithCacheRefreshMutation, PrebuildSimulationEvaluatorWorkerWithCacheRefreshMutationVariables>;
