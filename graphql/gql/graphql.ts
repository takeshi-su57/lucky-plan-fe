...
export type ContractInfoFragment = { __typename?: 'Contract', id: number, chainId: number, address: string, description?: string | null, status: ContractStatus } & { ' $fragmentName'?: 'ContractInfoFragment' };
