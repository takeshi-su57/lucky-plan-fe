...
export type GetSimulationEvaluatorWorkersQuery = { __typename?: 'Query', simulationEvaluatorWorkers: Array<{ __typename?: 'SimulationEvaluatorWorkerView', id: string, displayName: string, authorizationStatus: string, runtimeStatus: string, desiredState: string, desiredCapacity: number, activeCapacity: number, lastHeartbeatAt?: any | null, lastTaskAt?: any | null, lastError?: string | null, platformCaches: Array<{ __typename?: 'SimulationEvaluatorWorkerCacheView', platform: string, status: string, coveredStartAt?: any | null, coveredEndAt?: any | null, lastError?: string | null }>, prebuildProgress?: { __typename?: 'SimulationEvaluatorWorkerPrebuildProgressView', taskId: string, message: string, percent: number, records: string, totalRecords: string, bytes: string } | null }> };
