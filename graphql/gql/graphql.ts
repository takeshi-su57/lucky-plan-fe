...
export type BotDetailsInfoFragment = { __typename?: 'BotDetails', id: number, leaderAddress: string, followerAddress: string, contractId: number, strategyId: number, startedBlock?: number | null, endedBlock?: number | null, status: BotStatus, contract: (
    { __typename?: 'Contract' }
