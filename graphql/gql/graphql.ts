...
export type Simulation = {
  ...
  maxSlope: Scalars['Float']['output'];
  maxTrades: Scalars['Float']['output'];
  minR2: Scalars['Float']['output'];
  minSlope: Scalars['Float']['output'];
...
export type SimulationFloatRange = {
  __typename?: 'SimulationFloatRange';
  gap: Scalars['Float']['output'];
  max: Scalars['Float']['output'];
  min: Scalars['Float']['output'];
};

export type SimulationIntRange = {
  __typename?: 'SimulationIntRange';
...
export type UpdateSimulationInput = {
  ...
  id: Scalars['Int']['input'];
  maxLeverage?: InputMaybe<Scalars['Float']['input']>;
  maxR2?: InputMaybe<Scalars['Float']['input']>;
  maxSlope?: InputMaybe<Scalars['Float']['input']>;
  maxTrades?: InputMaybe<Scalars['Int']['input']>;
  minR2?: InputMaybe<Scalars['Float']['input']>;
  minSlope?: InputMaybe<Scalars['Float']['input']>;
...
export type SimulationBotInfoFragment = { __typename?: 'SimulationBot', avgCollateral: number, avgDuration: number, avgLeverage: number, avgNegativePnl: number, avgPnl: number, avgPnlPercentageByCollateral: number, avgPnlPercentageBySize: number, avgPositivePnl: number, avgSize: number, id: number, leaderAddress: string, leaderContractId: number, maxDuration: number, mode: BotMode, openedPositions: number, ratio: number, maxLeverage: number, simulationPlanId: number, startedAt: any, stoppedAt?: any | null, totalPnl: number, totalPositions: number, leaderContract: (
    { __typename?: 'Contract' }
    & { ' $fragmentRefs'?: { 'ContractInfoFragment': ContractInfoFragment } }
  ) } & { ' $fragmentName'?: 'SimulationBotInfoFragment' };

export type SimulationPlanInfoFragment = { __typename?: 'SimulationPlan', cursor: any, description: string, endAt: any, id: number, openedPositions: number, startAt: any, title: string, totalFollowerPnl: number, totalLeaderPnl: number, totalPositions: number, simulationBots: Array<(
    { __typename?: 'SimulationBot' }
    & { ' $fragmentRefs'?: { 'SimulationBotInfoFragment': SimulationBotInfoFragment } }
  )> } & { ' $fragmentName'?: 'SimulationPlanInfoFragment' };

export type SimulationInfoFragment = { __typename?: 'Simulation', completedPlans: number, createdAt: any, cursor?: any | null, description: string, direction: BotMode, endAt: any, error?: string | null, id: number, maxDrawdownUsd: number, maxLeverage: number, maxR2: number, maxSlope: number, maxTrades: number, minR2: number, minSlope: number, minTrades: number, platform: Platform, profitFactor: number, progressMessage?: string | null, progressPercent: number, progressPhase?: string | null, researchId?: number | null, selectedLeaderCount: number, standardCollateralUsd: number, startAt: any, status: SimulationStatus, title: string, totalCostUsd: number, totalFollowerPnl: number, totalLeaderPnl: number, totalNetPnlUsd: number, totalSimulationPlans: number, tradeCount: number, updatedAt: any, winRate: number } & { ' $fragmentName'?: 'SimulationInfoFragment' };

export type SimulationResearchInfoFragment = { __typename?: 'SimulationResearch', completedSimulations: number, createdAt: any, description: string, direction: BotMode, endAt: any, id: number, platform: Platform, startAt: any, title: string, totalSimulations: number, updatedAt: any, maxLeverageRange: { __typename?: 'SimulationFloatRange', gap: number, max: number, min: number }, maxR2Range: { __typename?: 'SimulationFloatRange', gap: number, max: number, min: number }, maxSlopeRange: { __typename?: 'SimulationFloatRange', gap: number, max: number, min: number }, maxTradesRange: { __typename?: 'SimulationIntRange', gap: number, max: number, min: number }, minR2Range: { __typename?: 'SimulationFloatRange', gap: number, max: number, min: number }, minSlopeRange: { __typename?: 'SimulationFloatRange', gap: number, max: number, min: number }, minTradesRange: { __typename?: 'SimulationIntRange', gap: number, max: number, min: number } } & { ' $fragmentName'?: 'SimulationResearchInfoFragment' };

export type SimulationResearchDetailsInfoFragment = { __typename?: 'SimulationResearchDetails', completedSimulations: number, createdAt: any, description: string, direction: BotMode, endAt: any, id: number, platform: Platform, startAt: any, title: string, totalSimulations: number, updatedAt: any, maxLeverageRange: { __typename?: 'SimulationFloatRange', gap: number, max: number, min: number }, maxR2Range: { __typename?: 'SimulationFloatRange', gap: number, max: number, min: number }, maxSlopeRange: { __typename?: 'SimulationFloatRange', gap: number, max: number, min: number }, maxTradesRange: { __typename?: 'SimulationIntRange', gap: number, max: number, min: number }, minR2Range: { __typename?: 'SimulationFloatRange', gap: number, max: number, min: number }, minSlopeRange: { __typename?: 'SimulationFloatRange', gap: number, max: number, min: number }, minTradesRange: { __typename?: 'SimulationIntRange', gap: number, max: number, min: number }, simulations: Array<(
    { __typename?: 'Simulation' }
...
export type SimulationBotDetailsInfoFragment = { __typename?: 'SimulationBotDetails', avgCollateral: number, avgDuration: number, avgLeverage: number, avgNegativePnl: number, avgPnl: number, avgPnlPercentageByCollateral: number, avgPnlPercentageBySize: number, avgPositivePnl: number, avgSize: number, id: number, leaderAddress: string, leaderContractId: number, maxDuration: number, mode: BotMode, openedPositions: number, ratio: number, simulationPlanId: number, startedAt: any, stoppedAt?: any | null, totalPnl: number, totalPositions: number, maxLeverage: number, leaderContract: (
    { __typename?: 'Contract' }
    & { ' $fragmentRefs'?: { 'ContractInfoFragment': ContractInfoFragment } }
  ), cacheState?: { __typename?: 'SimulationBotCacheState', completed: boolean, lastError?: string | null, lastFetchedAt?: any | null, rebuildRequested: boolean, rebuilding: boolean } | null, positions: Array<(
    { __typename?: 'SimulationTradePosition' }
...
export type CreateSimulationMutation = { __typename?: 'Mutation', createSimulation: (
    { __typename?: 'Simulation' }
    & { ' $fragmentRefs'?: { 'SimulationInfoFragment': SimulationInfoFragment } }
  ) };
...
export type PlayAutoSimulationMutation = { __typename?: 'Mutation', playAutoSimulation: (
    { __typename?: 'Simulation' }
    & { ' $fragmentRefs'?: { 'SimulationInfoFragment': SimulationInfoFragment } }
  ) };
...
export const PlayAutoSimulationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"playAutoSimulation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"playAutoSimulation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"SimulationInfo"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"SimulationInfo"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Simulation"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"completedPlans"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"cursor"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"direction"}},{"kind":"Field","name":{"kind":"Name","value":"endAt"}},{"kind":"Field","name":{"kind":"Name","value":"error"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"maxDrawdownUsd"}},{"kind":"Field","name":{"kind":"Name","value":"maxLeverage"}},{"kind":"Field","name":{"kind":"Name","value":"maxR2"}},{"kind":"Field","name":{"kind":"Name","value":"maxSlope"}},{"kind":"Field","name":{"kind":"Name","value":"maxTrades"}},{"kind":"Field","name":{"kind":"Name","value":"minR2"}},{"kind":"Field","name":{"kind":"Name","value":"minSlope"}},{"kind":"Field","name":{"kind":"Name","value":"minTrades"}},{"kind":"Field","name":{"kind":"Name","value":"platform"}},{"kind":"Field","name":{"kind":"Name","value":"profitFactor"}},{"kind":"Field","name":{"kind":"Name","value":"progressMessage"}},{"kind":"Field","name":{"kind":"Name","value":"progressPercent"}},{"kind":"Field","name":{"kind":"Name","value":"progressPhase"}},{"kind":"Field","name":{"kind":"Name","value":"researchId"}},{"kind":"Field","name":{"kind":"Name","value":"selectedLeaderCount"}},{"kind":"Field","name":{"kind":"Name","value":"standardCollateralUsd"}},{"kind":"Field","name":{"kind":"Name","value":"startAt"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"totalCostUsd"}},{"kind":"Field","name":{"kind":"Name","value":"totalFollowerPnl"}},{"kind":"Field","name":{"kind":"Name","value":"totalLeaderPnl"}},{"kind":"Field","name":{"kind":"Name","value":"totalNetPnlUsd"}},{"kind":"Field","name":{"kind":"Name","value":"totalSimulationPlans"}},{"kind":"Field","name":{"kind":"Name","value":"tradeCount"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"winRate"}}]}}]} as unknown as DocumentNode<PlayAutoSimulationMutation, PlayAutoSimulationMutationVariables>;
