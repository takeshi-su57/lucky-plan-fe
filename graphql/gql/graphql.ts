...
export type PerpTradeHistoryInfoFragment = { __typename?: 'PerpTradeHistory', id: number, address: string, collateralDeltaUsd: number, collateralInUsd: number, isLong: boolean, leverage: number, leverageDelta: number, operation: PerpTradeHistoryOperation, pair: string, positionKey: string, price: number, sizeDeltaUsd: number, sizeInUsd: number, usdPnl: number, date: any, contractId: number, platform: Platform } & { ' $fragmentName'?: 'PerpTradeHistoryInfoFragment' };
...
export type SimulationTradePositionInfoFragment = { __typename?: 'SimulationTradePosition', histories: Array<(
    { __typename?: 'SimulationTradeHistory' }
