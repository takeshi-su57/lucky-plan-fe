...
const documents: Documents = {
    ...
    "\n  query logReviewWeeks {\n    logReviewWeeks {\n      weekStart\n      reviewedAt\n      reviewedBy\n    }\n  }\n": types.LogReviewWeeksDocument,
    "\n  mutation reviewLogWeek($weekStart: Date!) {\n    reviewLogWeek(weekStart: $weekStart) {\n      weekStart\n      reviewedAt\n      reviewedBy\n    }\n  }\n": types.ReviewLogWeekDocument,
    ...
    "\n  query GetBackendReleaseInfo {\n    backendReleaseInfo {\n      version\n      gitSha\n      builtAt\n    }\n  }\n": types.GetBackendReleaseInfoDocument,
    "\n  query GetSimulationEvaluatorWorkers {\n    simulationEvaluatorWorkers {\n      id\n      displayName\n      authorizationStatus\n      runtimeStatus\n      desiredState\n      desiredCapacity\n      activeCapacity\n      version\n      versionReportedAt\n      claimedEvaluationTasks\n      evaluationClaimLimit\n      lastHeartbeatAt\n      lastTaskAt\n      lastError\n      lastDiagnosticAt\n      lastDiagnostic {\n        pid\n        uptimeSeconds\n        childCapacity\n        childCount\n        idleChildCount\n        runningTaskCount\n        lastPollAt\n        lastPollError\n        recentLogs {\n          at\n          level\n          message\n        }\n      }\n      platformCaches {\n        id\n        platform\n        status\n        coveredStartAt\n        coveredEndAt\n        lastError\n      }\n      prebuildProgress {\n        taskId\n        message\n        percent\n        records\n        totalRecords\n        bytes\n      }\n    }\n  }\n": types.GetSimulationEvaluatorWorkersDocument,
    "\n  query GetSimulationEvaluatorPipeline {\n    simulationEvaluatorPipeline {\n      fleetCapacity\n      queueLowWatermark\n      queueHighWatermark\n      workerClaimLimit\n      queuedEvaluationTasks\n      readyEvaluationTasks\n      claimedEvaluationTasks\n      awaitingFinalizationPlans\n      finalizingPlans\n      awaitingEventLogPlans\n      readyToFinalizeSimulations\n      finalizingSimulations\n      failedExecutionPlans\n      outstandingExecutionPlans\n      finalizerConcurrency\n      maxAwaitingFinalizationPlans\n      maxOutstandingDynamicPlans\n      backpressureActive\n      sourceDerivedWaitingToMaterialize\n      sourceDerivedReadyToRecalculate\n      sourceDerivedRecalculating\n      sourceDerivedFailed\n    }\n  }\n": types.GetSimulationEvaluatorPipelineDocument,
    "\n  mutation approveSimulationEvaluatorWorker($workerId: String!) {\n    approveSimulationEvaluatorWorker(workerId: $workerId) {\n      id\n    }\n  }\n": types.ApproveSimulationEvaluatorWorkerDocument,
    "\n  mutation rejectSimulationEvaluatorWorker($workerId: String!) {\n    rejectSimulationEvaluatorWorker(workerId: $workerId) {\n      id\n    }\n  }\n": types.RejectSimulationEvaluatorWorkerDocument,
    "\n  mutation removeRejectedSimulationEvaluatorWorker($workerId: String!) {\n    removeRejectedSimulationEvaluatorWorker(workerId: $workerId)\n  }\n": types.RemoveRejectedSimulationEvaluatorWorkerDocument,
    "\n  mutation removeOfflineSimulationEvaluatorWorker($workerId: String!) {\n    removeOfflineSimulationEvaluatorWorker(workerId: $workerId)\n  }\n": types.RemoveOfflineSimulationEvaluatorWorkerDocument,
    "\n  mutation prebuildSimulationEvaluatorWorkerWithCacheRefresh(\n    $workerId: String!\n    $platform: String!\n    $startedAt: String!\n    $endedAt: String!\n    $refreshExisting: Boolean\n  ) {\n    prebuildSimulationEvaluatorWorker(\n      workerId: $workerId\n      platform: $platform\n      startedAt: $startedAt\n      endedAt: $endedAt\n      refreshExisting: $refreshExisting\n    )\n  }\n": types.PrebuildSimulationEvaluatorWorkerWithCacheRefreshDocument,
    "\n  query GetSimulationEvaluatorWorkerTasks($workerId: String) {\n    simulationEvaluatorWorkerTasks(workerId: $workerId) {\n      id\n      kind\n      status\n      syncStatus\n      platform\n      targetWorkerId\n      workerId\n      rangeStartedAt\n      rangeEndedAt\n      claimedAt\n      leaseExpiresAt\n      completedAt\n      progressPercent\n      progressMessage\n      progressRecords\n      progressTotalRecords\n      progressBytes\n      lastError\n      timingJson\n      canCancel\n      createdAt\n    }\n  }\n": types.GetSimulationEvaluatorWorkerTasksDocument,
    "\n  query GetSimulationEvaluatorWorkerTaskConnection(\n    $workerId: String!\n    $archive: Boolean!\n    $cursor: String\n    $limit: Int!\n  ) {\n    simulationEvaluatorWorkerTaskConnection(\n      workerId: $workerId\n      archive: $archive\n      cursor: $cursor\n      limit: $limit\n    ) {\n      nextCursor\n      items {\n        id\n        kind\n        status\n        syncStatus\n        platform\n        targetWorkerId\n        workerId\n        rangeStartedAt\n        rangeEndedAt\n        claimedAt\n        leaseExpiresAt\n        completedAt\n        progressPercent\n        progressMessage\n        progressRecords\n        progressTotalRecords\n        progressBytes\n        lastError\n        timingJson\n        canCancel\n        createdAt\n      }\n    }\n  }\n": types.GetSimulationEvaluatorWorkerTaskConnectionDocument,
    "\n  mutation retrySimulationEvaluatorWorkerCache($cacheId: Int!) {\n    retrySimulationEvaluatorWorkerCache(cacheId: $cacheId)\n  }\n": types.RetrySimulationEvaluatorWorkerCacheDocument,
    "\n  mutation removeSimulationEvaluatorWorkerCache($cacheId: Int!) {\n    removeSimulationEvaluatorWorkerCache(cacheId: $cacheId)\n  }\n": types.RemoveSimulationEvaluatorWorkerCacheDocument,
    "\n  mutation pauseSimulationEvaluatorWorker($workerId: String!) {\n    pauseSimulationEvaluatorWorker(workerId: $workerId) {\n      id\n    }\n  }\n": types.PauseSimulationEvaluatorWorkerDocument,
    "\n  mutation resumeSimulationEvaluatorWorker($workerId: String!) {\n    resumeSimulationEvaluatorWorker(workerId: $workerId) {\n      id\n    }\n  }\n": types.ResumeSimulationEvaluatorWorkerDocument,
    "\n  mutation setSimulationEvaluatorWorkerCapacity(\n    $workerId: String!\n    $capacity: Float!\n  ) {\n    setSimulationEvaluatorWorkerCapacity(\n      workerId: $workerId\n      capacity: $capacity\n    )\n  }\n": types.SetSimulationEvaluatorWorkerCapacityDocument,
    "\n  mutation upgradeSimulationEvaluatorWorker(\n    $workerId: String!\n    $version: String!\n  ) {\n    upgradeSimulationEvaluatorWorker(workerId: $workerId, version: $version)\n  }\n": types.UpgradeSimulationEvaluatorWorkerDocument,
    "\n  mutation cancelUnassignedSimulationEvaluatorWorkerTask($taskId: String!) {\n    cancelUnassignedSimulationEvaluatorWorkerTask(taskId: $taskId)\n  }\n": types.CancelUnassignedSimulationEvaluatorWorkerTaskDocument,
    "\n  query GetSimulationWorkflowConfig {\n    simulationWorkflowConfig {\n      maxSimulationsPerResearch\n      maxOutstandingDynamicPlans\n      finalizerBatchSize\n      finalizerConcurrency\n      sourceDerivedRecalculationConcurrency\n      finalizerBotCacheConcurrency\n      finalizerRetryDelayMs\n      maxAwaitingFinalizationPlans\n      finalizerLeaseMs\n      evaluatorTaskLeaseMs\n      queuedTaskBatchSize\n      readyTaskScanLimit\n      eventLogAddressBatchSize\n      eventLogRecordBatchSize\n      prebuildChunkSourceRecordLimit\n      leaderScoringWindowDays\n      candidateRecentActivityDays\n      botTraderMinAvgDurationMs\n    }\n  }\n": types.GetSimulationWorkflowConfigDocument,
    "\n  mutation UpdateSimulationWorkflowConfig(\n    $input: UpdateSimulationWorkflowConfigInput!\n  ) {\n    updateSimulationWorkflowConfig(input: $input) {\n      maxOutstandingDynamicPlans\n    }\n  }\n": types.UpdateSimulationWorkflowConfigDocument,
    "\n  mutation RestoreSimulationWorkflowDefaults {\n    restoreSimulationWorkflowDefaults {\n      maxOutstandingDynamicPlans\n    }\n  }\n": types.RestoreSimulationWorkflowDefaultsDocument,
    ...
    "\n  mutation createSimulationResearchFromSimulation(\n    $sourceSimulationId: Int!\n    $input: CreateSimulationResearchInput!\n  ) {\n    createSimulationResearchFromSimulation(\n      sourceSimulationId: $sourceSimulationId\n      input: $input\n    ) {\n      id\n      ...SimulationResearchInfo\n    }\n  }\n": types.CreateSimulationResearchFromSimulationDocument,
