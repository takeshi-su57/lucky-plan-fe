...
const documents: Documents = {
    ...
    "\n  fragment WalkForwardResultInfo on WalkForwardResult {\n    id\n    candidateId\n    windowIndex\n    status\n    trainStart\n    trainEnd\n    trainMetrics\n    testStart\n    testEnd\n    testMetrics\n    consistency\n    degradation\n    errorMessage\n    createdAt\n  }\n": types.WalkForwardResultInfoFragmentDoc,
    "\n  fragment RobustnessTestInfo on RobustnessTest {\n    id\n    candidateId\n    stepIndex\n    status\n    startDate\n    endDate\n    metrics\n    sharpeRatio\n    totalPnl\n    maxDrawdown\n    errorMessage\n    createdAt\n  }\n": types.RobustnessTestInfoFragmentDoc,
    ...
    "\n  mutation StartValidationPipeline($id: ID!) {\n    startValidationPipeline(id: $id) {\n      ...ValidationPipelineInfo\n    }\n  }\n": types.StartValidationPipelineDocument,
